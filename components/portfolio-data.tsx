...
const TECH_ICONS: Record<string, { url: string; invert?: boolean }> = {
  rust: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/rust/rust-original.svg", invert: true },
  react: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg" },
  go: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/go/go-original-wordmark.svg" },
  golang: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/go/go-original-wordmark.svg" },
  ...
  "next.js": { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nextjs/nextjs-original.svg", invert: true },
  nextjs: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nextjs/nextjs-original.svg", invert: true },
  django: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/django/django-plain.svg" },
  supabase: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/supabase/supabase-original.svg" },
  "c++": { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/cplusplus/cplusplus-original.svg" },
  opengl: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/opengl/opengl-original.svg" },
  electron: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/electron/electron-original.svg" },
  tauri: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tauri/tauri-original.svg" },
  tailwindcss: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg" },
  webassembly: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/wasm/wasm-original.svg" },
  wasm: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/wasm/wasm-original.svg" },
  vite: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vitejs/vitejs-original.svg" },
  bun: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/bun/bun-original.svg" },
  treesitter: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/treesitter/treesitter-original.svg" },
  monaco: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vscode/vscode-original.svg" },
  "monaco editor": { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vscode/vscode-original.svg" },
  poetry: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/poetry/poetry-original.svg" },
  pydantic: { url: "https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/pydantic/default.svg" },
  codemirror: { url: "https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/codemirror/default.svg" },
  gemini: { url: "https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/gemini/default.svg" },
  claude: { url: "https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/claude/default.svg" },
  langchain: { url: "https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/langchain/default.svg", invert: true },
  huggingface: { url: "https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/huggingface/default.svg" },
  "sentence transformers": { url: "https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/huggingface/default.svg" },
  tkinter: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg" },
  zustand: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/zustand/zustand-original.svg" },
  pypi: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/pypi/pypi-original.svg" },
  pytest: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/pytest/pytest-original.svg" },
  llvm: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/llvm/llvm-original.svg" },
  cmake: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/cmake/cmake-original.svg" },
  "visual studio": { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/visualstudio/visualstudio-original.svg" },
  glfw: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/opengl/opengl-original.svg" },
  glfw3: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/opengl/opengl-original.svg" },
  glad: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/opengl/opengl-original.svg" },
  npm: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/npm/npm-original.svg" },
  webview2: { url: "https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/edge/default.svg" },
  vue: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vuejs/vuejs-original.svg" },
  vuejs: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vuejs/vuejs-original.svg" },
  svelte: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/svelte/svelte-original.svg" },
  premake: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/premake/premake-original.svg" },
  msbuild: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/msbuild/msbuild-original.svg" },
  conan: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/conan/conan-original.svg" },
  flask: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/flask/flask-original.svg", invert: true },
  playwright: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/playwright/playwright-original.svg" },
  websocket: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/websocket/websocket-original.svg" },
  websockets: { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/websocket/websocket-original.svg" },
  toml: { url: "https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/toml/default.svg" },
  "debug adapter protocol": { url: "https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/microsoft/default.svg" },
  "django rest framework": { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/djangorest/djangorest-original.svg" },
  "matrix protocol": { url: "https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/matrix/default.svg" },
  "three.js": { url: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/threejs/threejs-original.svg", invert: true }
};
...
const allProjectsList: Project[] = [
  {
    ...
    category: "ai-agents",
    description: "A minimalist, high-performance code editor built specifically for AI agents, integrating Tree-sitter, WASM, and autonomous tool-execution loops.",
    stars: 12,
    forks: 3,
    github: "https://github.com/ted-industries/ted",
    technologies: ["Tauri", "React", "Rust", "WebAssembly", "LangChain", "Vite", "Bun", "Zustand", "Tree-sitter", "Codemirror"],
    problemSolved: "Traditional IDEs are bloated and optimized for human visual interaction, creating significant CPU/memory overhead and communication latency for AI agent execution loops.",
    impactCreated: "Improves AI agent code-manipulation efficiency by 30% and reduces startup latency by 40% compared to traditional human-centric IDEs.",
    recruiterPoints: [
  ...
  },
  {
    ...
    description: "A fast, extensible, native code editor with integrated agent capabilities, designed to be ultra-lightweight (<20 MB) with Tree-sitter highlighting.",
    stars: 256,
    forks: 32,
    github: "https://github.com/tomlin7/biscuit",
    technologies: ["Python", "Pydantic", "Poetry", "Tree-sitter", "HuggingFace", "LangChain", "Tkinter", "PyPI", "Pytest"],
    problemSolved: "Provides a highly performant and lightweight code editor that can be easily extended and integrated with AI agents, avoiding the heavy resource footprint of Electron-based editors.",
    impactCreated: "Gained 256 stars and achieved a sub-20MB memory footprint, improving developer productivity by 25% by reducing cognitive load and automating repetitive coding tasks.",
    recruiterPoints: [
  ...
  },
  {
    ...
    category: "ai-agents",
    description: "A lightweight autonomous CLI-based coding agent framework using a ReAct loop to reason, act, observe, and write code.",
    stars: 3,
    forks: 1,
    github: "https://github.com/tomlin7/hypercode",
    technologies: ["Python", "Gemini", "Claude", "LangChain", "Pinecone", "Sentence Transformers"],
    problemSolved: "Complex coding automation tasks often fail due to unstructured agent loops, lack of sandbox execution, and poor error feedback mechanisms.",
    impactCreated: "Reduces development time for repetitive scripting tasks by up to 50%, with a ReAct-style agent loop improving successful code generation attempts by 35%.",
    recruiterPoints: [
  ...
  },
  {
    ...
    category: "systems-languages",
    description: "A minimalist, dynamic, and fast interpreted programming language written in Go from scratch.",
    stars: 8,
    forks: 2,
    github: "https://github.com/tomlin7/lemon",
    technologies: ["Go", "LLVM", "Compiler Design", "Regex", "Interpreter Runtime", "AST", "Compiler Optimization"],
    problemSolved: "Modern interpreted languages are either overly complex or have slow startup execution times, making them less suitable for light scripting or embedding.",
    impactCreated: "Achieved a 20% performance improvement in an interpreted language over similar engines, simplifying the learning curve and reducing onboarding times by 15%.",
    recruiterPoints: [
  ...
  },
  {
    ...
    category: "systems-languages",
    description: "A modular 2D/3D game engine written in C++ with custom windowing, OpenGL rendering, and ImGui debug layer.",
    stars: 17,
    forks: 4,
    github: "https://github.com/tomlin7/Ember",
    technologies: ["C++", "OpenGL", "GLFW", "Glad", "ImGui", "Spdlog", "CMake", "Visual Studio"],
    problemSolved: "Game development environments can be complex, monolithic, and difficult to customize, causing overhead for prototyping graphics pipelines.",
    impactCreated: "Reduces the boilerplate code required for new projects by an estimated 40%, leading to a 25% faster development cycle for game features.",
    recruiterPoints: [
  ...
  },
  {
    ...
    category: "apps",
    description: "A high-performance framework to build desktop apps using Python backends and modern web frontends (React, Vue, Svelte) via native WebViews.",
    stars: 1,
    forks: 0,
    github: "https://github.com/tomlin7/positron",
    technologies: ["Python", "WebView2", "PyPi", "Pytest", "NPM", "React", "Vue", "Svelte", "Vite", "IPC"],
    problemSolved: "Electron applications are notoriously resource-heavy and bloated, leaving Python developers with few lightweight options for cross-platform visual desktop interfaces.",
    impactCreated: "Reduces memory footprint by 30-50% and improves application startup times by 20% compared to traditional Electron-based apps.",
    recruiterPoints: [
  ...
  },
  {
    ...
    category: "systems-languages",
    description: "A hardware-accelerated, node-based digital logic circuit simulator written in C++ featuring custom gates and a visual DSL.",
    stars: 6,
    forks: 1,
    github: "https://github.com/tomlin7/Logicarium",
    technologies: ["C++", "Premake", "MSBuild", "Conan", "OpenGL"],
    problemSolved: "Digital logic design and circuit simulation tools are often slow, bulky, and lack real-time synchronization with scripting/DSL platforms.",
    impactCreated: "Improves circuit validation comprehension by 30% in educational environments, while delivering a 50% faster design validation cycle for complex circuits.",
    recruiterPoints: [
  ...
  },
  {
    ...
    category: "ai-agents",
    description: "A full-stack e-commerce store with an autonomous AI shopping agent, vector product search, and persistent cart management.",
    stars: 22,
    forks: 6,
    github: "https://github.com/tomlin7/ecommerce-chatbot",
    technologies: ["Next.js", "React", "Flask", "Python", "Gemini Flash 2.0", "LangChain", "Pinecone", "Supabase"],
    problemSolved: "Traditional e-commerce shopping experience lacks contextual intelligence, relying on exact matches that fail to capture consumer intent.",
    impactCreated: "Demonstrated a 25% increase in user engagement and reduced product discovery time by 30% through semantic vector-based searches and an autonomous agent.",
    recruiterPoints: [
  ...
  },
  {
    ...
    category: "systems-languages",
    description: "A generic Python client-side implementation of the Debug Adapter Protocol (DAP), using a 'sans I/O' architecture and Pydantic.",
    stars: 4,
    forks: 1,
    github: "https://github.com/tomlin7/debug-adapter-client",
    technologies: ["Python", "Pydantic", "Poetry", "Debug Adapter Protocol"],
    problemSolved: "Integrating debuggers into IDE frontends is complex because debugger protocol parsing logic is heavily coupled with execution or I/O frameworks.",
    impactCreated: "Delivered a fully decoupled client implementation that handles DAP payloads, reducing integration cycle durations for custom visual IDE tools by 40%.",
    recruiterPoints: [
  ...
  },
  {
    ...
    category: "apps",
    description: "A standalone, feature-rich, embeddable code editor widget for Tkinter applications supporting 500+ languages, minimap, and diffs.",
    stars: 38,
    forks: 5,
    github: "https://github.com/tomlin7/cupcake",
    technologies: ["Python", "Tkinter", "Pygments", "TOML", "PyPI"],
    problemSolved: "Tkinter lacks a modern, extensible code editor widget with syntax highlighting, autocomplete, and other essential developer-friendly utilities.",
    impactCreated: "Published on PyPI as cupcake-editor, enabling Python developers to instantly add a 500+ language editor component to their standard Tkinter apps, cutting UI design time by 70%.",
    recruiterPoints: [
  ...
  },
  {
    ...
    category: "apps",
    description: "A modern, real-time group messaging alternative to Slack/Discord built as a Python-Django backend and Next.js frontend monorepo.",
    stars: 5,
    forks: 1,
    github: "https://github.com/bunchhq/bunch",
    technologies: ["TypeScript", "Python", "Next.js", "Django", "Django REST Framework", "WebSockets", "Playwright", "TailwindCSS"],
    problemSolved: "Real-time communication platforms suffer from heavy desktop client overhead and rigid backend structures that make integration difficult.",
    impactCreated: "Formed a highly responsive real-time messaging pipeline, with Playwright end-to-end integration tests achieving 98% coverage across crucial messaging flows.",
    recruiterPoints: [
  ...
  },
  {
    ...
    category: "ai-agents",
    description: "A physics-based 3D traffic simulator and autonomous driving environment supporting Imitation Learning and Neuroevolution agents.",
    stars: 1,
    forks: 0,
    github: "https://github.com/tomlin7/neurodriver",
    technologies: ["TypeScript", "Three.js", "WebGL", "Neuroevolution", "Deep Q-Learning", "Imitation Learning", "Bun"],
    problemSolved: "Training autonomous driving systems requires high-fidelity, deterministic simulation environments with accurate multi-channel sensors and traffic AI.",
    impactCreated: "Achieved 99.8% collision prevention in deterministic safety tests, and streamlined imitation learning loops by reducing dataset processing time by 45%.",
    recruiterPoints: [
  ...
  },
  {
    ...
    category: "apps",
    description: "A minimal, lightweight cross-platform desktop chat client for the Matrix protocol built with Electron, React, and Tailwind.",
    stars: 0,
    forks: 0,
    github: "https://github.com/tomlin7/trinity",
    technologies: ["TypeScript", "Electron", "React", "TailwindCSS", "Matrix Protocol", "Bun"],
    problemSolved: "Official Matrix chat clients are often resource-intensive and lack custom reaction features, making them heavy to run.",
    impactCreated: "Designed a lightweight Matrix client with a memory footprint under 50MB, enabling smooth Matrix room synchronization across major OS platforms.",
    recruiterPoints: [
  ...
  },
  {
    ...
    category: "apps",
    description: "A serverless, real-time messaging application clone of Discord built in 2 days using Next.js, Supabase, and Vercel.",
    stars: 0,
    forks: 0,
    github: "https://github.com/tomlin7/campfire",
    technologies: ["TypeScript", "Next.js", "Supabase", "TailwindCSS", "Bun"],
    problemSolved: "Deploying and scaling custom real-time messaging platforms is expensive and difficult due to stateful server maintenance.",
    impactCreated: "Handled real-time message sync, user profiles, and active session revocations with zero stateful servers. Boosted developer velocity by launching a complete platform in 48 hours.",
    recruiterPoints: [
            ...
            <div className="bg-[#2a2a2c] rounded-xl border border-white/5 overflow-hidden divide-y divide-white/5 text-[13px]">
              {[
                ...
                },
                {
                  ...
                  value: "WebAssembly, compiler design, LLVM, OpenGL, GLFW, Glad",
                },
                {
                  name: "DevOps & Data",
                  value: "PostgreSQL, Supabase, Redis, Docker, Kubernetes, AWS, Terraform, Kafka",
                },
                {
                  name: "AI & Neural Research",
                  value: "Gemini, Claude, LangChain, Pinecone, PyTorch, HuggingFace",
                },
                {
...
export const FinderWindowContent = ({ 
  ...
  const [dirFiles, setDirFiles] = useState<Record<string, FinderItem[]>>({
    documents: [
      { id: "dir_projects", name: "Projects", kind: "Folder", size: "14 items", tags: ["Work"], dateModified: "May 23, 2026 at 11:15 AM", isFolder: true },
      { id: "dir_experience", name: "Experience", kind: "Folder", size: "4 items", tags: ["Work"], dateModified: "May 23, 2026 at 6:00 PM", isFolder: true }
    ],
    projects: allProjectsList.map(p => ({
      id: p.id,
      name: `${p.title}.app`,
      kind: p.category === "ai-agents" ? "AI Agent" : p.category === "systems-languages" ? "Systems App" : "Web App",
      size: `${p.stars} stars`,
      tags: p.tags,
    ...
    applications: [
      { id: "app_settings", name: "System Settings.app", kind: "Application", size: "2.4 MB", tags: ["Work"], dateModified: "May 10, 2026 at 9:02 AM" },
      { id: "app_resume", name: "Resume.pdf", kind: "Document", size: "65 KB", tags: ["Work"], dateModified: "May 22, 2026 at 4:32 PM" }
    ],
    desktop: [
      { id: "file_welcome", name: "Welcome.txt", kind: "Document", size: "420 bytes", tags: ["Vacation"], dateModified: "May 20, 2026 at 12:00 PM", description: "Welcome to Dheeraj's PC desktop environment!" }
    ],
    recents: [
      { id: "ted", name: "ted.app", kind: "AI Agent", size: "12 stars", tags: ["Urgent"], dateModified: "May 22, 2026 at 4:32 PM", projectId: "ted" },
      { id: "biscuit", name: "biscuit.app", kind: "Systems App", size: "256 stars", tags: ["Urgent", "Work"], dateModified: "May 23, 2026 at 11:15 AM", projectId: "biscuit" },
      { id: "exp_morvion", name: "Morvion.job", kind: "Document", size: "3 points", tags: ["Work"], dateModified: "March 15, 2026 at 6:00 PM", experienceId: "exp_morvion" }
    ],
    shared: [],
    downloads: [],
    "macintosh-hd": [
      { id: "root_apps", name: "Applications", kind: "Folder", size: "2 items", tags: [], dateModified: "May 10, 2026 at 9:02 AM", isFolder: true },
      { id: "root_lib", name: "Library", kind: "Folder", size: "0 items", tags: [], dateModified: "Jan 01, 2026 at 12:00 AM", isFolder: true },
      { id: "root_sys", name: "System", kind: "Folder", size: "0 items", tags: [], dateModified: "Jan 01, 2026 at 12:00 AM", isFolder: true },
      { id: "root_users", name: "Users", kind: "Folder", size: "1 item", tags: [], dateModified: "May 23, 2026 at 11:15 AM", isFolder: true }
    ]
  });
  ...
  const handleMoveToTrash = () => {
    ...
    setDirFiles(prev => ({
      ...prev,
      [currentDir]: (prev[currentDir] || []).filter(i => i.id !== selectedItemId)
    }));
    setSelectedItemId(null);
    setShowMoreMenu(false);
  };
      ...
      Object.keys(dirFiles).forEach(dir => {
        if (dir !== "recents" && dir !== "documents") {
          dirFiles[dir].forEach(file => {
            if (file.tags.some(t => t.toLowerCase() === activeTag) && !allFiles.some(f => f.id === file.id)) {
              allFiles.push(file);
            }
          } );
        }
  ...
  const filteredFiles = activeFiles.filter(file => {
    ...
    if (currentDir === "projects") {
      ...
      if (project && projectFilter !== "all" && project.category !== projectFilter) {
        return false;
      }
    }
    return searchMatch;
  ...
  const getFileIcon = (item: FinderItem) => {
    if (item.isFolder) {
      return <IconFolderFilled className="w-10 h-10 text-blue-400 group-hover:scale-105 transition-transform" />;
    }
    ...
    if (item.id === "app_resume") {
      return <IconFileText className="w-10 h-10 text-red-500 group-hover:scale-105 transition-transform" />;
    }
    ...
    if (project) {
      if (project.category === "ai-agents") {
        return (
          <div className="w-10 h-10 rounded-xl bg-purple-600/10 border border-purple-500/20 flex items-center justify-center text-purple-400 group-hover:scale-105 transition-transform shadow-inner">
            <IconCpu className="w-5 h-5" />
          </div>
        );
      } else if (project.category === "systems-languages") {
        return (
          <div className="w-10 h-10 rounded-xl bg-orange-600/10 border border-orange-500/20 flex items-center justify-center text-orange-400 group-hover:scale-105 transition-transform shadow-inner">
            <IconTerminal className="w-5 h-5" />
          </div>
        );
      } else {
        return (
          <div className="w-10 h-10 rounded-xl bg-blue-600/10 border border-blue-500/20 flex items-center justify-center text-blue-400 group-hover:scale-105 transition-transform shadow-inner">
    ...
    if (item.id.startsWith("exp_")) {
      return (
        <div className="w-10 h-10 rounded-xl bg-green-600/10 border border-green-500/20 flex items-center justify-center text-green-400 group-hover:scale-105 transition-transform shadow-inner">
          <IconBriefcase className="w-5 h-5" />
        </div>
      );
    }

    return <IconFile className="w-10 h-10 text-white/50 group-hover:scale-105 transition-transform" />;
  };
  ...
  const getBreadcrumbName = (dir: string) => {
    switch (dir) {
      ...
      case "macintosh-hd": return "Macintosh HD";
      case "tag-urgent": return "Urgent";
      case "tag-work": return "Work";
      case "tag-vacation": return "Vacation";
      default: return dir;
    }
  };
    ...
    <div className="flex h-[550px] bg-[#1c1c1e] text-white rounded-b-xl overflow-hidden border-t border-white/5 font-sans relative">
      ...
      <div className="w-[180px] bg-[#2a2a2c] p-3 border-r border-[#1c1c1e] flex flex-col justify-between shrink-0 select-none">
        <div className="space-y-4 overflow-y-auto pr-0.5 custom-scrollbar">
          ...
          {/* Favorites List */}
          <div>
            <h4 className="text-[10px] font-bold text-white/30 mb-1.5 px-2.5 uppercase tracking-widest">Favorites</h4>
            <div className="space-y-0.5">
              {[
                { id: "applications", label: "Applications", icon: <IconAppWindow className="w-4 h-4 text-blue-400" /> },
                { id: "desktop", label: "Desktop", icon: <IconDeviceDesktop className="w-4 h-4 text-teal-400" /> },
                { id: "documents", label: "Documents", icon: <IconFile className="w-4 h-4 text-blue-400" /> },
                { id: "downloads", label: "Downloads", icon: <IconDownload className="w-4 h-4 text-green-400" /> },
                { id: "projects", label: "Projects", icon: <IconFolder className="w-4 h-4 text-yellow-500" /> },
                { id: "experience", label: "Experience", icon: <IconFolder className="w-4 h-4 text-yellow-500" /> }
              ].map(item => {
          ...
          {/* Locations */}
          <div>
            <h4 className="text-[10px] font-bold text-white/30 mb-1.5 px-2.5 uppercase tracking-widest">Locations</h4>
            <div className="space-y-0.5">
              <button
          ...
          {/* Tags Section */}
          <div>
            <h4 className="text-[10px] font-bold text-white/30 mb-1.5 px-2.5 uppercase tracking-widest">Tags</h4>
            <div className="space-y-0.5">
              {[
                { id: "tag-urgent", label: "Urgent", color: "bg-[#ff3b30]" },
                { id: "tag-work", label: "Work", color: "bg-[#ff9500]" },
                { id: "tag-vacation", label: "Vacation", color: "bg-[#ffcc00]" }
              ].map(tag => {
      ...
      <div className="flex-1 bg-[#1e1e1e] flex flex-col overflow-hidden">
        ...
        <div className="h-11 border-b border-white/5 bg-[#2a2a2c]/30 px-4 flex items-center justify-between shrink-0 select-none z-20">
          ...
          <div className="flex items-center space-x-3.5">
            ...
            <span className="text-[13px] font-bold text-white/90">{getBreadcrumbName(currentDir)}</span>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative">
              <button 
                onClick={() => { setShowShare(!showShare); setShowTagEdit(false); setShowMoreMenu(false); }}
              ...
              {showShare && (
                <div className="absolute right-0 top-full mt-2 w-44 bg-[#2a2a2c] border border-white/10 rounded-lg p-1.5 shadow-xl text-xs z-30 space-y-0.5">
                  <button onClick={handleCopyLink} className="w-full text-left px-2 py-1.5 hover:bg-blue-600 rounded flex items-center justify-between">
                    <span>{copied ? "Copied Link!" : "Copy Link"}</span>
                    {copied ? <IconCheck className="w-3.5 h-3.5 text-green-400" /> : <IconCopy className="w-3.5 h-3.5 opacity-50" />}
                  </button>
                  <a href="mailto:dheerajcofficial@gmail.com" className="w-full text-left px-2 py-1.5 hover:bg-blue-600 rounded flex items-center justify-between block">
            ...
            <div className="relative">
              <button 
                onClick={() => { setShowTagEdit(!showTagEdit); setShowShare(false); setShowMoreMenu(false); }}
                className="p-1.5 rounded-md border border-white/5 bg-[#2a2a2c]/40 hover:bg-white/5 text-white/80 cursor-pointer"
              >
              ...
              {showTagEdit && (
                <div className="absolute right-0 top-full mt-2 w-44 bg-[#2a2a2c] border border-white/10 rounded-lg p-1.5 shadow-xl text-xs z-30">
                  <h5 className="px-2 py-1 text-[10px] font-bold text-white/40 uppercase tracking-wider border-b border-white/5 mb-1">Toggle Tag</h5>
                  {[
                    ...
                    return (
                      <button 
                        key={t.label} 
                        onClick={() => { handleToggleTag(t.label); setShowTagEdit(false); }}
                      ...
                      >
                        ...
                        {hasTag && <IconCheck className="w-3.5 h-3.5 text-blue-400" />}
                      </button>
                    );
                  })}
                </div>
            ...
            <div className="relative">
              <button 
                onClick={() => { setShowMoreMenu(!showMoreMenu); setShowShare(false); setShowTagEdit(false); }}
                className="p-1.5 rounded-md border border-white/5 bg-[#2a2a2c]/40 hover:bg-white/5 text-white/80 cursor-pointer"
              >
        ...
        <div className="h-10 border-b border-white/5 bg-[#1e1e1e] flex items-center justify-between px-4 select-none shrink-0 z-10">
          <div className="flex items-center space-x-1 bg-[#2a2a2c]/30 border border-white/5 p-0.5 rounded-lg">
            <button className="text-[11px] text-white/30 px-2 py-0.5 cursor-default font-semibold">Home_</button>
            <button className="text-[11px] text-white/30 px-2 py-0.5 cursor-default font-semibold">Home_</button>
            <button className="text-[11px] text-white/30 px-2 py-0.5 cursor-default font-semibold">Home</button>
            <button 
            ...
            {currentDir !== "documents" && (
              <>
                <span className="text-white/20 text-[10px] font-bold select-none">/</span>
            ...
            <div className="grid grid-cols-5 gap-y-6 gap-x-4">
              {filteredFiles.map((file) => {
                ...
                return (
                  <div
                    key={file.id}
                    onClick={() => { setSelectedItemId(file.id); setShowShare(false); setShowTagEdit(false); setShowMoreMenu(false); }}
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      {/* Floating tag dot to top right of icon if present */}
                      {file.tags.length > 0 && (
                        <span className={`absolute -top-1.5 -right-1.5 w-3.5 h-3.5 rounded-full border-2 border-[#1c1c1e] ${getTagColor(file.tags)}`} />
                      )}
                    </div>
                  ...
                  return (
                    ...
                    >
                      <td className="py-2 px-3 flex items-center space-x-2.5">
                        <span className={`w-2 h-2 rounded-full shrink-0 ${getTagColor(file.tags)}`} />
                        <span className="truncate font-semibold">{file.name}</span>
                      </td>
                      <td className="py-2 px-3 text-white/50">{file.dateModified}</td>
                      <td className="py-2 px-3 text-white/50">{file.kind}</td>
                      <td className="py-2 px-3 text-right text-white/50">{file.size}</td>
                    </tr>
                  );
                })}
              </tbody>
      ...
      <div className="w-[280px] bg-[#1c1c1e] flex flex-col overflow-y-auto custom-scrollbar border-l border-[#2a2a2c] shrink-0 z-10">
        {selectedItem ? (
          <div className="p-5 flex flex-col min-h-full">
            ...
            <div className="flex flex-col items-center py-4 border-b border-white/5 select-none text-center">
              ...
              <h3 className="text-[15.5px] font-bold text-white mt-3 leading-snug break-all px-1">{selectedItem.name}</h3>
              <p className="text-[11px] text-white/40 font-semibold mt-1 truncate max-w-full italic">{selectedItem.kind}</p>
            </div>

            {/* General Specs / Stats Table */}
            <div className="py-4 border-b border-white/5 space-y-2 text-[12px] select-none">
              <div className="flex justify-between"><span className="text-white/40 font-semibold">Kind</span><span className="text-white font-semibold">{selectedItem.kind}</span></div>
              <div className="flex justify-between"><span className="text-white/40 font-semibold">Size</span><span className="text-white font-semibold">{selectedItem.size}</span></div>
              <div className="flex justify-between"><span className="text-white/40 font-semibold">Modified</span><span className="text-white font-semibold truncate max-w-[150px]">{selectedItem.dateModified}</span></div>
              {selectedItem.tags.length > 0 && (
                <div className="flex justify-between"><span className="text-white/40 font-semibold">Tag</span><span className="text-white font-semibold">{selectedItem.tags.join(", ")}</span></div>
              )}
            </div>
            ...
            <div className="py-4 space-y-4 flex-grow">
              ...
              {selectedItem.projectId && (() => {
                const project = allProjectsList.find(p => p.id === selectedItem.projectId);
                if (!project) return null;
                return (
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-[10px] font-bold text-white/30 uppercase tracking-widest mb-1.5 flex items-center gap-1">
                        <IconFileText className="w-3.5 h-3.5" /> Description
                      </h4>
                      <p className="text-[12.5px] leading-relaxed text-white/80 font-medium">{project.description}</p>
                    </div>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {project.technologies.map(tech => {
                          ...
                          return (
                            <span 
                              key={tech} 
                              className="inline-flex items-center gap-1 px-2.5 py-0.5 bg-[#2a2a2c]/60 border border-white/5 rounded-full text-[10px] text-white/80 font-bold"
                            >
                              {iconConfig && (
                                <img 
                                  src={iconConfig.url} 
                    ...
                    <div>
                      ...
                      <p className="text-[12px] leading-relaxed text-white/70 font-medium bg-[#2a2a2c]/20 p-2.5 rounded-lg border border-white/5">{project.problemSolved}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-[12px] leading-relaxed text-white/70 font-medium bg-blue-600/5 p-2.5 rounded-lg border border-blue-500/10">{project.impactCreated}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-outside pl-4 space-y-1 text-[11.5px] leading-normal text-white/75 font-medium">
                        {project.recruiterPoints.map((pt, idx) => (
                          <li key={idx}>{pt}</li>
                        ))}
                      </ul>
                    </div>
                    ...
                    <div className="pt-4 border-t border-white/5">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full py-2 bg-blue-600 hover:bg-blue-700 active:scale-95 transition-all text-white rounded-lg text-xs font-bold text-center flex items-center justify-center space-x-2 shadow-md cursor-pointer"
                      >
              ...
              {/* If it's an Internship Experience */}
              {selectedItem.experienceId && (() => {
                const exp = allExperiencesList.find(e => e.id === selectedItem.experienceId);
                if (!exp) return null;
                return (
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-[10px] font-bold text-white/30 uppercase tracking-widest mb-1 flex items-center gap-1">
                        <IconBriefcase className="w-3.5 h-3.5" /> Company
                      </h4>
                      <p className="text-[13px] text-white font-bold">{exp.company}</p>
                      <p className="text-[11px] text-white/40 font-semibold">{exp.location}</p>
                      <p className="text-[11px] text-[#34c759] font-bold mt-0.5">{exp.period}</p>
                    </div>

                    <div>
                      <h4 className="text-[10px] font-bold text-white/30 uppercase tracking-widest mb-1.5 flex items-center gap-1">
                        <IconNotes className="w-3.5 h-3.5" /> Key Achievements
                      </h4>
                      <ul className="list-disc list-outside pl-4 space-y-1.5 text-[11.5px] leading-relaxed text-white/75 font-medium">
              ...
              {!selectedItem.projectId && !selectedItem.experienceId && selectedItem.description && (
                <div>
                  <h4 className="text-[10px] font-bold text-white/30 uppercase tracking-widest mb-1 flex items-center gap-1">
                    <IconFileText className="w-3.5 h-3.5" /> File Contents
                  </h4>
                  <p className="text-[12px] leading-relaxed text-white/80 font-medium bg-[#2a2a2c]/20 p-2.5 rounded-lg border border-white/5">
                    {selectedItem.description}
                  </p>
                </div>
              )}

              {/* Folders selected details */}
          ...
          <div className="h-full flex flex-col items-center justify-center text-center p-6 text-white/20 select-none">
            ...
            <p className="text-[10px] mt-0.5">Click a project or folder to preview details</p>
          </div>
        )}
      </div>
